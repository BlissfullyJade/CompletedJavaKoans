...
public class AboutTryWithResources {
    ...
    public void supressException() {
        String message = "Exception thrown while working Exception thrown while closing";
        try {
            bar();
        ...
        assertEquals(message, "Exception thrown while working Exception thrown while closingException thrown while working Exception thrown while closing");
    }
