...
public class AboutMocks {
    ...
    public void simpleAnonymousMock() {
        // HINT: pass a SafeCollaborator implementation to constructor
        // new ClassUnderTest(new Collaborator(){... it should not be the
        // objective of this test to test that collaborator, so replace it
    	SafeCollaborator froggy = new SafeCollaborator(); 
    	//instantiating froggy as a new collaborartor and calling the dosomething function
        new ClassUnderTest(froggy).doSomething();
        // its taking a new instance and calling the froggy collaborartor and calling the dosomething object
