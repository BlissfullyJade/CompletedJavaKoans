...
public class AboutEnums {
    ...
    public void enumsWithMethods() {
        assertEquals(OpticalMedia.CD.getCoolnessFactor(), OpticalMedia.CD.getCoolnessFactor());
        assertEquals(OpticalMedia.BluRay.getCoolnessFactor(), OpticalMedia.BluRay.getCoolnessFactor());
    }
}
