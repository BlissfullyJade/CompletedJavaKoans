...
public class AboutStrings {
    ...
    public void implicitStrings() {
    	String g = "just a plain ole string" ;
        assertEquals("just a plain ole string".getClass(), g.getClass());
    }
    ...
    public void stringTrim() {
        ...
        assertEquals(" o".trim(), "o");
        assertEquals("hi ".trim(), "hi");
    ...
    public void stringUpperCase() {
        String str = "Jade";
        assertEquals(str.toUpperCase(), "JADE");
    }

    @Koan
    public void stringLowerCase() {
        String str = "Jade";
        assertEquals(str.toLowerCase(), "jade");
    }

    @Koan
    public void stringCompare() {
        String str = "jade";
        assertEquals(str.compareTo("Jade") == 0, false);
    ...
    public void stringSubstring() {
        String str = "hi";
        assertEquals(str.substring(0), "hi");
        assertEquals(str.substring(1), "i");
